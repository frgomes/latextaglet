...
/**
 * Taglet class for equation style formulaey<br>
 * 
...
public class LaTeXEquationTaglet extends LaTeXTaglet {
     ...
     */
	public static void register(final Map<String, LaTeXEquationTaglet> tagletMap) {
       final LaTeXEquationTaglet tag = new LaTeXEquationTaglet();
